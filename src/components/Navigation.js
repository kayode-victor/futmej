    ...
    <>
      <header className="py-10 absolute w-full z-[3]">
        <div className="container px-4 mx-auto flex items-center justify-between">
          <div>
            <Link href="/" className="text-[22px] text-gray-700 font-extrabold">
              FUT
              <span className="text-green-600">-</span>MEJ
        ...
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className="pointer-events-none fixed inset-y-0 right-0 flex m-w-full pl-10">
                <Transition.Child
                  as={Fragment}
                  ...
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-sm">
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                      ...
                      <div className="bprder-t border-gray-200 px-4 py-6 sm:px-6">
                        <Link
                          href="/contact"
                          className="block text-center text-[11.5px] tracking-[2px] font-bold uppercase bg-green-600 py-4 px-5 text-white"
                        >
                          Contact us now
                        </Link>
                      </div>
